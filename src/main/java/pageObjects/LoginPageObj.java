...
public class LoginPageObj extends Base {
  ...
  // this is a practice line to check in git hup and push the information and update the git hup
	//so this is a very important to learn how to push file from eclipse and imported in git Hup
	public LoginPageObj() {
...
/// this my fist eclipse commit
	// This is one the check code from Githup to Eclipse
}
